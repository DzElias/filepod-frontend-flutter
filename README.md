...
El componente backend de FilePod está desarrollado utilizando NodeJs y se puede encontrar en el siguiente repositorio: [FilePod Backend](https://github.com/elialm7/filepod-backend-node).
