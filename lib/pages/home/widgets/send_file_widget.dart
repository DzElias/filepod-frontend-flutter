...
class SendFileWidget extends StatefulWidget {
  final data;
  const SendFileWidget({super.key, this.data});
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: Center(
                            child: Text(
                              "${SOCKETURI}download/${widget.data}",
                        ...
                        MouseRegion(
                          ...
                          child: GestureDetector(
                            onTap: () => copy("${SOCKETURI}file/preview/${widget.data} "),
                            child: Container(
                              height: 45,
                              decoration: const BoxDecoration(
                                color: Colors.black87,
                    ...
                    QrImageView(
                      data:
                          "${SOCKETURI}file/preview/${widget.data}", // Generate QR code from the URL provided as a parameter
                      version: QrVersions.auto,
                      size: 200.0,
                    ),
                    GestureDetector(
                        onTap: () => _shareQRImage(widget.data),
                        child: MouseRegion(
                            cursor: SystemMouseCursors.click,
                            child: Container(
                                padding: const EdgeInsets.all(10),
